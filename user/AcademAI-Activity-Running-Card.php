...
<head>
    ...
    <link rel="stylesheet" href="../css/academAI-activity-running-card.css">
...
<div class="mcq-container">
  ...
  <div class="icon-search"><i class="fas fa-search"></i></div>
    ...
    <div class="card" id="running-card-modal-Btn">
        ...
        <div class="title">
            <h2 class="card-title">Ancient Civilizations Quiz</h2>
        </div>

        <div class="title">
            <h2 class="card-title1">History</h2>
        </div>

        <div class="card-content">
            <div>
                <a href="AcademAI-Running-People-Join.php" class="people-link"><i class="fas fa-users"></i> People who join</a>
            </div>
            <div class="start-end">
            <div class="start">
                <p class="card-description">Start Date: March 20, 2024</p>
                <p class="card-description">Start Time: 11:00 AM</p>
            </div>
            <div class="end">
                <p class="card-description">End Date: March 20, 2024</p>
    ...
    <div class="card">
        ...
        <div class="title">
            <h2 class="card-title">Culinary Connoisseur Quiz</h2>
        </div>

        <div class="title">
            <h2 class="card-title1">Food/Cooking</h2>
        </div>
        ...
        <div class="card-content">
            ...
            <div class="end">
                <p class="card-description">End Date: March 21, 2024</p>
                <p class="card-description">End Time: 10:59 AM</p>
            </div>
        </div>
    </div>
</div>
...
<div id="running-card-modal" class="modal">
    <div class="modal-content">
        ...
        <img src="../img/modal/modal-q-9.gif" alt="Circle Image" class="center-image"> <!-- Second Image (Circle Image) -->
        <form action="#">
  ...
  <div class="modal-dialog">
    ...
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        ...
        <div class="yes-btn">
            <a href="AcademAI-Join-Quiz-MCQ.php" class="yes-btn-exit">Yes</a> <!-- Yes Button -->
            <a href="AcademAI-Activity-Running-Card.php" class="cancel-btn-exit">No</a> <!-- Cancel Button -->
            </div>
            </div>
    </div>
  </div>
