...
<div class="mcq-container">
  ...
  <div class="icon-search"><i class="fas fa-search"></i></div>
    ...
    <div class="card" id="upcoming-card-modalBtn">
        <a href="AcademAI-Library-Completed-View-Card.php">
        ...
        <div class="title">
            <h2 class="card-title">Human Mind</h2>
        </div>

        <div class="title">
            <h2 class="card-title1">Psychology</h2>
        </div>

        <div class="card-content">
            <div>
                <a href="AcademAI-Library-Completed-People-Join.php" class="people-link"><i class="fas fa-users"></i> People who join</a>
            </div>
            <div class="start-end">
            <div class="start">
    ...
    <div class="card">
        ...
        <div class="title">
            <h2 class="card-title">Space and Galaxy</h2>
        </div>

        <div class="title">
            <h2 class="card-title1">Astronomy</h2>
        </div>
  ...
  <div class="modal-dialog">
    ...
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        ...
        <div class="submit-content">
            ...
            <a href="AcademAI-Completed-Running-Card.php" class="cancel-btn">No</a> <!-- Cancel Button -->
            <a href="AcademAI-Completed-Card.php" class="yes-btn">Yes</a> <!-- Yes Button -->
        </div>
    </div>
  </div>
</div>
