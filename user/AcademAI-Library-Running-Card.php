...
<div class="mcq-container">
  ...
  <div class="search-container">
    ...
    <div class="card" id="upcoming-card-modalBtn">
        <a href="AcademAI-Library-Running-View Card.php">
        ...
        <div class="title">
            <h2 class="card-title">Home Abonie</h2>
        </div>

        <div class="title">
            <h2 class="card-title1">Carpentry</h2>
        </div>

        <div class="card-content">
            <div>
                <a href="AcademAI-Library-Running-People-Join.php" class="people-link"><i class="fas fa-users"></i> People who join</a>
            </div>
            <div class="start-end">
            <div class="start">
    ...
    <div class="card">
        ...
        <div class="title">
            <h2 class="card-title">Taior Needs</h2>
        </div>

        <div class="title">
            <h2 class="card-title1">Fashion Design</h2>
        </div>
    ...
    <div class="card">
        ...
        <div class="title">
            <h2 class="card-title">Einstein Problem</h2>
        </div>

        <div class="title">
            <h2 class="card-title1">Physics</h2>
        </div>
    ...
    <div class="card">
        ...
        <div class="title">
            <h2 class="card-title">Tress Falling</h2>
        </div>

        <div class="title">
            <h2 class="card-title1">Environmental Science</h2>
        </div>
  ...
  <div class="modal-dialog">
    ...
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        <div class="half-image">
            <img src="../img/modal/modal-4.gif" alt="First Image" style="width: 100%; height: 100%;">
        </div>
        ...
        <div class="submit-content">
            ...
            <a href="AcademAI-Library-Running-Card.php" class="cancel-btn">No</a> <!-- Cancel Button -->
            <a href="AcademAI-Library-Running-Card.php" class="yes-btn">Yes</a> <!-- Yes Button -->
        </div>
    </div>
  </div>
</div>
