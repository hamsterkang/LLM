...
<div class="divide-content"> 
    <div class="author-descript">
            <div class="author-info">  
                ...
                <p class="the-title-quiz"> Ancient Civilizations</p>
                </div>
                </div>
                <div class="d-flex">
                <p class="descrip">Description:</p>
                <p class="the-descrip">Ancient history!</p>
                </div>  
                ...
                <p class="the-startdate">April 11, 2024</p>         
                </div>

                <div class="d-flex ">
                <p class="starttime">Start time:</p>
                <p class="the-starttime">10:AM</p>
                </div>
                <div class="d-flex ">
                <p class="enddate">End Date:</p>
                <p class="the-enddate"> April 12, 2024</p>
                </div>
                ...
                <p class="the-endtime">10:00 Pm</p>
                </div>
