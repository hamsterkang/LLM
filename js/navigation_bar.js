...
// Javascript for academAI-nav-bar.php
...
//  End of Javascript for academAI-nav-bar.php
...
navItems.forEach((item) => item.addEventListener("mouseenter", handleNavHover));
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (urlParams.has('logged_out')) {
        console.log("Logged out parameter found in URL.");
